...
document.getElementById("dogdress").addEventListener("click", function () {
    document.getElementById("PDdress").style.display = "block";
});
...
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCblack").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCwhite").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCbeige").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCgrey").style.display = "none";
});

// Dog Color
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDcorgi").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDhusky").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDshepherd").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDwhite").style.display = "none";
});


//Fit check at end
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCcowboy").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCangel").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCdress").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PCtux").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDcowboy").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDangel").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDtux").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("PDtux").style.display = "none";
});
...
//Accessory Display at end
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Pcowboyhat").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Phalo").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Pflower").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Ptophat").style.display = "none";
});

//Toy Display at end
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Pmouse").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Pyarn").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Pball").style.display = "none";
});
document.getElementById("playagain").addEventListener("click", function () {
    document.getElementById("Pbone").style.display = "none";
});